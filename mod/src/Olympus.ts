...
class Olympus implements IPreSptLoadModAsync, IPostDBLoadMod 
{
    private pkg;
    ...
    public postDBLoad(container: DependencyContainer): void 
    {
        ...
        this.modConfig = jsonc.parse(this.fileSystem.read(path.resolve(__dirname, "../config.jsonc")))
    ...
    public updateItems(container: DependencyContainer): void 
    {
        ...
        const {
            ...
            cartridgeCount,
            athenaArmorAmount,
            herculesRig2ArmorAmount,
            helmetofhermesArmorAmount,
            atlassatchelHorizontal,
            atlassatchelVertical,
            numberOfStimUses,
            stimUseTimeInSeconds
        } = this.modConfig;
        ...
        const stringValue: string = "1-" + String(roundedNumber);
